...
/datum/component/storage/proc/generate_bound_underlay(grid_width = 32, grid_height = 32)
	var/mutable_appearance/bound_underlay = mutable_appearance(icon = 'modular_tfn/modules/gridventory/storage.dmi')
...
/atom/movable/screen/close
	icon = 'modular_tfn/modules/gridventory/storage.dmi'
	icon_state = "close"
	var/locked = TRUE
