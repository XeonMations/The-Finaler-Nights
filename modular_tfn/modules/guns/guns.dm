/obj/item/gun/ballistic/vampire
	icon = 'modular_tfn/modules/guns/weapons.dmi'
	lefthand_file = 'modular_tfn/master_files/icons/mob/inhands//ighthand.dmi.dmi'
	righthand_file = 'modular_tfn/master_files/icons/mob/inhands/lefthand.dmi'
	worn_icon = 'modular_tfn/master_files/icons/mob/clothing/worn.dmi'
	onflooricon = 'modular_tfn/modules/onfloor/onfloor.dmi'
	can_suppress = FALSE
	recoil = 2
...
/obj/item/vampire_flamethrower/afterattack(atom/target, mob/user, flag)
	...
	if(HAS_TRAIT(user, TRAIT_PACIFISM))
		to_chat(user, "<span class='warning'>You can't bring yourself to fire /the [src]! You don't want to risk harming anyone...</span>")
		return
